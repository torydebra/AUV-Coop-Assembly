...
*****************************************************************************************************************/
  ...
  double goalLinearVectTool[] = {0.2091283425451932, -3.923779232740178, 4.83148256529992};
  std::vector<double> eulRad = {0, 0, -1.477081797139538};
...
void setTaskLists(std::string robotName, std::vector<Task*> *tasks1,
  ...
  /// PREREQUISITE TASKS
  Task* forceInsert = new ForceInsertTask(3, ineqType, robotName);
