...
*****************************************************************************************************************/
  ...
  double goalLinearVectTool[] = {-0.27, -1.102, 5.000};
...
*******************************************************************************************************************/
  ...
  kdlHelper.getFixedFrame("end_effector", "pegHead", &(eeTtool));
  std::cout << "eeTtool__________________-\n"<< eeTtool << "\n";
  robInfo.transforms.wTt_eigen = robInfo.robotState.wTv_eigen * robInfo.robotState.vTee_eigen * eeTtool;
  std::cout << "wTtool__________________-\n"<< robInfo.transforms.wTt_eigen << "\n";
...
void setTaskLists(std::string robotName, std::vector<Task*> *tasks1,
  ...
  /// PREREQUISITE TASKS
  Task* forceInsert = new ForceInsertTask(3, eqType, robotName);
